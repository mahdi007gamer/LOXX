...
export const translations: TranslationDictionary = {
 ...
 betaShieldDesc: { fa: "در حال حاضر هسته نسل جدید استریمینگ لوکس در حالت آزمایشی (Beta) قرار دارد. این زیرساخت هوشمند با بهره‌گیری از الگوریتم‌های انحصاری شبکه، در تلاش است تا با مدیریت فوق‌پیشرفته ترافیک، بالاترین کیفیت تصویر را با کمترین تاخیر و پینگ برای گیمرها ارائه دهد. تیم مهندسی ما در حال گسترش و بهینه‌سازی مداوم این معماری ابری-هیبریدی است.", en: "The next-generation LOXX streaming engine is currently in its beta phase. This smart infrastructure leverages exclusive networking algorithms to deliver ultra-high video quality with near-zero latency through advanced traffic routing. Our engineering team is continuously fine-tuning this hybrid-cloud architecture for optimal peak performance." },
