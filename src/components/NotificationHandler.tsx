...
const InviteToast = ({ t, inviteData, navigate }: { t: any, inviteData: any, navigate: any }) => {
  ...
  return (
    <motion.div 
      ...
      className="modern-glass-toast relative flex flex-col gap-5 w-[360px] p-6 bg-[#0d0d14]/80 backdrop-blur-3xl rounded-[28px] border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.8)] overflow-hidden group" 
      dir="rtl"
    >
      {/* Top Accent Line */}
