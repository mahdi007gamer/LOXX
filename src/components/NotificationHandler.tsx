...
const InviteToast = ({ t, inviteData, navigate }: { t: any, inviteData: any, navigate: any }) => {
 ...
 className="modern-glass-toast relative flex flex-col gap-5 w-[calc(100vw-32px)] sm:w-[360px] max-w-[360px] min-w-[280px] sm:min-w-[360px] shrink-0 p-6 bg-[#0d0d14]/80 rounded-[28px] border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.8)] overflow-hidden group" 
 dir="rtl"
 >
 {/* Top Accent Line */}
