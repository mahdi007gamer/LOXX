...
export const GenreAdminModal = ({ 
 ...
 <div>
 <label className="block text-[10px] font-black text-gray-400 uppercase mb-3">نام ژانر</label>
 <input 
 type="text" 
 value={name}
 ...
 <div>
 <label className="block text-[10px] font-black text-gray-400 uppercase mb-4">انتخاب آیکون متناسب</label>
 ...
 type="submit" 
 loading={loading} 
 className="w-full h-14 rounded-2xl font-black text-sm uppercase "
 >
