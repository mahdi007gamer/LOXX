...
export const GameAdminModal = ({ 
 ...
 <div>
 <label className="block text-xs font-black text-gray-400 uppercase mb-3">نام بازی</label>
 <input 
 type="text" 
 ...
 <div>
 <label className="block text-xs font-black text-gray-400 uppercase mb-3">آیکون بازی (1:1)</label>
 ...
 <div>
 <label className="block text-xs font-black text-gray-400 uppercase mb-3">نشان مخصوص بازی (بج)</label>
 <select 
 ...
 <div>
 <label className="block text-xs font-black text-gray-400 uppercase mb-3">بنر بازی (16:9)</label>
 <div className="relative group">
 ...
 <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2">
 <div>
 <label className="block text-xs font-black text-gray-400 uppercase mb-4">انتخاب ژانرها (چند انتخابی)</label>
 ...
 <div>
 <label className="block text-xs font-black text-gray-400 uppercase mb-4">ریجن‌های تحت پوشش</label>
