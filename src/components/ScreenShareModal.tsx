      ...
      <div className={cn("space-y-5 text-gray-200", isRtl ? "text-right font-sans" : "text-left font-sans")} dir={isRtl ? "rtl" : "ltr"}>
        ...
        <div className="bg-gradient-to-r from-orange-500/10 to-transparent border border-orange-500/20 rounded-2xl p-4 relative overflow-hidden">
          ...
          <div className="flex gap-3 items-start relative z-10">
            <span className="p-2.5 bg-orange-500/15 text-orange-400 rounded-xl border border-orange-500/20 font-extrabold text-xs shrink-0 self-center tracking-tight animate-pulse">
              BETA
            </span>
        ...
        <div className="space-y-2">
          <label className="text-[11px] font-bold text-gray-400 uppercase tracking-wider block mr-1">
        ...
        <div className="pt-2 border-t border-white/5 flex gap-3 items-center">
          <GlowButton 
            ...
            className={cn(
              "w-full h-12 flex items-center justify-center gap-2 font-black tracking-widest text-xs uppercase italic", 
