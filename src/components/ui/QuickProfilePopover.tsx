...
export const QuickProfilePopover: React.FC<QuickProfilePopoverProps> = ({
 ...
 <p className="text-[9px] text-gray-500 font-extrabold uppercase mb-1">
 ...
 <p
 className="text-[9px] font-black uppercase mb-1.5 group-hover:text-neon-blue transition-colors "
 style={{
 color:
 ...
 <div className="text-center group">
 <p
 className="text-[9px] font-black uppercase mb-1.5 group-hover:text-neon-pink transition-colors "
 style={{
 color:
 metadata?.colors?.statsLabel ||
 (isVIP ? "#451a03" : "#4b5563"),
 ...
 <div className="text-center group">
 <p
 className="text-[9px] font-black uppercase mb-1.5 group-hover:text-neon-purple transition-colors "
 style={{
 color:
 metadata?.colors?.statsLabel ||
 (isVIP ? "#451a03" : "#4b5563"),
 ...
 <div className="text-center group">
 <p
 className="text-[9px] font-black uppercase mb-1.5 group-hover:text-yellow-500 transition-colors "
 style={{
 color:
 metadata?.colors?.statsLabel ||
 (isVIP ? "#451a03" : "#4b5563"),
 ...
 <h5 className="text-[11px] font-extrabold uppercase text-neon-purple flex gap-2 items-center justify-center">
 ...
 <GlowButton
 variant="purple"
 className="w-full h-16 !rounded-3xl font-black text-base uppercase shadow-2xl relative overflow-hidden group bg-gradient-to-r from-red-700 via-red-500 to-red-700 text-white border-none shadow-[0_10px_40px_rgba(239,68,68,0.3)] hover:scale-[1.02] transition-transform"
 onClick={handleMessage}
 >
 ...
 <span className="flex items-center gap-2 group-hover:scale-110 transition-transform font-black uppercase">
