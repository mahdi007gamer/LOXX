...
export const FriendChatOverlay = () => {
 ...
 <span className="font-black text-xs text-white uppercase ">تنظیمات لایو لابی و اعلانات</span>
 ...
 {/* Header */}
 <div className="flex items-center justify-between border-b border-white/5 bg-white/5 px-4 py-3">
 <span className="font-black text-xs text-white uppercase ">گفتگوی دوستان (DM)</span>
 ...
 <p className="text-[13px] font-black text-white uppercase">{activeFriend?.displayName || activeChat?.tempDisplayName || (activeChatId === "1" ? "شما" : "کاربر")}</p>
 ...
 <div className="flex flex-col items-start min-w-0">
 <span className="text-[11px] font-black truncate overflow-hidden whitespace-nowrap">{displayName}</span>
