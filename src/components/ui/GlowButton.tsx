...
export const GlowButton = React.forwardRef<HTMLButtonElement, GlowButtonProps>(
 ...
 md: "px-6 py-3 text-sm font-black ",
 lg: "px-10 py-4 text-base font-black ",
 };
 ...
 className={cn(
 "inline-flex items-center justify-center rounded-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-neon-blue disabled:opacity-50 disabled:cursor-not-allowed uppercase font-black cursor-pointer",
 variants[variant],
 sizes[size],
 className
 )}
