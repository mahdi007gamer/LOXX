...
export const LobbyOverlay = () => {
 ...
 <h4 className="text-white font-black text-xl truncate max-w-[150px] leading-tight" dir="auto">
 {lobby.title || "لابی"}
 </h4>
 <div className="flex items-center gap-2 mt-1 flex-row">
 <span className="px-2 py-0.5 rounded-[10px] bg-neon-blue/10 text-[9px] font-black text-neon-blue uppercase border border-neon-blue/20">
 {lobby.status}
 </span>
