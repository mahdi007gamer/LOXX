...
export const AdminStreamersPage = () => {
 ...
 <h1 className="text-4xl font-black text-white ">مدیریت استریمرها</h1>
 </div>
 <p className="text-gray-400 font-bold uppercase text-[10px] opacity-60 mr-14">Streamer Partner Ecosystem</p>
 </div>
 <GlowButton 
 variant="purple"
 size="sm"
 className="h-12 px-6 text-[10px] uppercase font-black !rounded-2xl"
 ...
 className={`pb-4 px-3 md:px-6 text-xs md:text-sm font-black uppercase transition-all relative ${
 ...
 <div>
 <p className="text-[9px] text-gray-500 uppercase font-black mb-1">موجودی</p>
 <p className="text-white font-mono">{s.balance?.toLocaleString()} <span className="text-[8px]">تومان</span></p>
 </div>
 <div>
 <p className="text-[9px] text-gray-500 uppercase font-black mb-1">کل درآمد</p>
 <p className="text-white font-mono">{s.totalEarned?.toLocaleString()} <span className="text-[8px]">تومان</span></p>
 </div>
 <div>
 <p className="text-[9px] text-gray-500 uppercase font-black mb-1">تخفیف کاربر</p>
 <p className="text-white font-mono">{s.userDiscountPercent}%</p>
 </div>
 <div>
 <p className="text-[9px] text-gray-500 uppercase font-black mb-1">سهم استریمر</p>
 <p className="text-white font-mono">{s.streamerCommissionPercent}%</p>
 </div>
 <div className="col-span-2">
 <p className="text-[9px] text-gray-500 uppercase font-black mb-1">درخواست‌های معلق</p>
 ...
 <span className="text-yellow-400 font-bold uppercase ">درخواست تسویه</span>
 ...
 <GlowButton variant="blue" className="w-full md:w-auto mt-4" onClick={handleCreateInvite}>
 ایجاد صفحه پروپوزال
 </GlowButton>
 </NeonCard>
 ...
 <span className="text-gray-600 ">بدون پیشنهاد یا پیام خاص</span>
 )}
 </td>
