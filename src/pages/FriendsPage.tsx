...
export const FriendsPage = () => {
 ...
 <div className="flex items-center gap-2 text-xs font-bold text-neon-blue uppercase px-2">
 ...
 {cat.count === 0 && <p className="py-4 text-center text-[10px] text-gray-600 ">{isRtl ? "هیچ موردی یافت نشد" : "No results found"}</p>}
 </motion.div>
 )}
 </AnimatePresence>
 </div>
 ...
 <span className="text-[10px] md:text-xs text-gray-500 font-mono truncate">@{user?.username}</span>
 <button 
 onClick={() => {
