...
export const LeaderboardPage = () => {
 ...
 <p className="text-[10px] text-neon-pink font-black uppercase ">
 ...
 <h3 className="text-xl font-black text-white uppercase ">{podium[1].username}</h3>
 ...
 <h3 className="text-2xl font-black text-white uppercase ">{podium[0].username}</h3>
 <p className="text-4xl text-yellow-400 font-black mt-2 ">{podium[0].points.toLocaleString()}</p>
 </NeonCard>
 </motion.div>
 )}
 ...
 <h3 className="text-xl font-black text-white uppercase ">{podium[2].username}</h3>
 ...
 <h4 className="font-black text-white group-hover:text-neon-blue transition-colors truncate uppercase text-sm md:text-base ">{player.username}</h4>
 </div>
 <div className="text-left">
 <p className="text-[9px] text-gray-500 uppercase font-black mb-0.5">
 {isRtl ? "امتیازات" : "Match XP"}
 </p>
 <p className="font-black text-lg md:text-xl text-white ">{player.points.toLocaleString()}</p>
 </div>
 </div>
 </motion.div>
 ))
 ...
 !loading && (
 <p className="text-gray-500 font-bold text-center p-8 bg-white/5 rounded-3xl border border-dashed border-white/10">
 ...
 <GlowButton 
 variant="blue" 
 className="w-full py-4 text-xs font-black uppercase mt-8"
 ...
 <h3 className="text-xl font-black text-white uppercase mb-6 relative z-10">
 ...
 <span className="text-xs font-black text-white uppercase ">{rule.label}</span>
 ...
 <div>
 <p className="text-[10px] text-neon-blue font-black uppercase mb-1">
 ...
 <p className="text-white font-black text-xl">{userRank.points.toLocaleString()}</p>
 </div>
 </div>
