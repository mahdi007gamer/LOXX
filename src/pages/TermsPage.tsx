...
export const TermsPage = () => {
 ...
 <div>
 <h2 className={`text-lg font-black text-white mb-2 ${isRtl ? 'text-right' : 'text-left'}`}>
 ...
 <h3 className="text-xl font-black text-white flex items-center gap-3 border-r-4 border-neon-pink pr-3">
 ...
 {/* English Section 1 */}
 <section className="space-y-3.5">
 <h3 className="text-xl font-black text-white flex items-center gap-3 border-l-4 border-neon-pink pl-3">
 ...
 <div className="px-6 py-2 rounded-2xl bg-neon-pink/5 border border-neon-pink/20 text-xs font-black text-neon-pink uppercase">
