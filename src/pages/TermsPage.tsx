...
import { BookOpen, ShieldAlert, Calendar, HelpCircle } from 'lucide-react';

export const TermsPage = () => {
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-[#07070F] pt-32 pb-24 text-right" dir="rtl">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          >
            ...
            <p className="text-gray-400 font-sans text-sm md:text-base max-w-xl mx-auto leading-relaxed">
              شرایط استفاده از پلتفرم گیمینگ و جامعه بازیکنان لوکس (LOXX)
            </p>
            <div className="inline-flex items-center gap-2 mt-4 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs text-gray-400 font-sans">
              ...
              <span>تاریخ آخرین بروزرسانی: ۲۶ اردیبهشت ۱۴۰۵ (۱۵ می ۲۰۲۶)</span>
            </div>
          </motion.div>
          ...
          >
            <NeonCard variant="pink" className="p-6 md:p-8 bg-black/40 backdrop-blur-2xl border-none">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h2 className="text-lg font-black text-white italic mb-2">کاربر گرامی و گرانقدر لوکس</h2>
              ...
              <section className="space-y-3.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                  ...
                  <div className="p-4 rounded-2xl bg-white/[0.01] border border-white/5 hover:border-white/10 transition-all col-span-1 md:col-span-2">
                    <strong className="text-neon-pink block mb-1">اشتراک VIP/PLUS و محتوای کاربر:</strong>
