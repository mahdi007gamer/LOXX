...
export const LobbiesPage = () => {
 ...
 <h1 className="text-2xl md:text-3xl lg:text-4xl font-black text-white uppercase leading-tight">
 {isRtl ? (
 ...
 <h3 className="text-xl md:text-3xl font-black text-white uppercase mb-2 md:mb-3">{isRtl ? "لابی فعالی یافت نشد" : "No Active Lobbies"}</h3>
 ...
 {/* VIP Badge */}
 {isVipLobby && (
 <div className="absolute top-4 left-4 z-30 flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[9px] font-black uppercase bg-yellow-400 text-dark-bg shadow-lg shadow-yellow-400/20 ">
