    ...
    return (
      <div className="flex h-screen items-center justify-center bg-[#050507]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-neon-blue font-black italic animate-pulse">درحال بارگذاری پروفایل...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex min-h-[calc(100vh-64px)]">
        ...
        <main className={cn("flex-1 px-4 py-8 flex flex-col items-center justify-center text-center transition-all duration-300", !isSidebarCollapsed ? "md:mr-64 mr-0" : "md:mr-20 mr-0")}>
          ...
          <h2 className="text-2xl font-black text-white italic uppercase tracking-tighter">کاربر یافت نشد</h2>
          <p className="text-gray-500 text-sm mt-2 font-bold">پروفایلی با این مشخصات در لوکس وجود ندارد.</p>
          <GlowButton variant="blue" className="mt-8 px-10 !rounded-2xl font-black italic" onClick={() => navigate(-1)}>بازگشت به صفحه قبل</GlowButton>
        </main>
      </div>
    );
  }
            ...
            <div className="px-10 pb-10">
              <div className="relative -mt-20 flex flex-col items-end gap-8 sm:flex-row">
                ...
                <div className="flex-1 pt-6 text-center sm:text-right w-full">
                  ...
                  <p className="mt-4 text-gray-400 text-sm max-w-2xl leading-relaxed italic line-clamp-2">{profile.bio || "بایوگرافی هنوز تنظیم نشده است"}</p>
                </div>
                
                <div className="flex items-center gap-3 self-center sm:self-end mt-4 sm:mt-0">
                  <GlowButton 
                    variant="blue" 
                    className="px-8 h-12 gap-2 !rounded-2xl font-black italic text-xs uppercase"
                    onClick={() => {
          ...
          <div className="grid gap-8 md:grid-cols-3">
              ...
              <NeonCard variant="blue" className="p-8">
                ...
                <div className="grid grid-cols-1 gap-4">
                   <div className="flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/5">
                      <span className="text-[10px] text-gray-500 font-black uppercase italic">دوستان</span>
                      <span className="text-xl font-black text-white italic italic">{profile.stats?.friendsCount || 0}</span>
                   </div>
                   <div className="flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/5">
                      <span className="text-[10px] text-gray-500 font-black uppercase italic">لابی‌های شرکت کرده</span>
                      <span className="text-xl font-black text-white italic">{profile.stats?.lobbiesJoined || 0}</span>
                   </div>
                   <div className="flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/5">
                      <span className="text-[10px] text-gray-500 font-black uppercase italic">لابی‌های ایجاد شده</span>
                      <span className="text-xl font-black text-white italic">{profile.stats?.lobbiesCreated || 0}</span>
                   </div>
                </div>
              </NeonCard>
            ...
            <div className="md:col-span-2 space-y-6">
              <NeonCard className={cn(
                ...
                <h3 className="text-2xl font-black text-white italic tracking-tighter mb-6 uppercase">اطلاعات لوکس</h3>
                ...
                <div className="mt-12 pt-8 border-t border-white/5 grid grid-cols-2 lg:grid-cols-4 gap-6">
                   <div className="text-center">
                      <p className="text-[9px] text-gray-600 font-black uppercase italic mb-1 tracking-widest">Level</p>
                      <p className="text-2xl font-black text-white italic tracking-tighter">{profile.level || 1}</p>
                   </div>
                   <div className="text-center">
                      <p className="text-[9px] text-gray-600 font-black uppercase italic mb-1 tracking-widest">Status</p>
                      <p className="text-2xl font-black text-neon-blue italic tracking-tighter">ONLINE</p>
                   </div>
                   <div className="text-center">
                      <p className="text-[9px] text-gray-600 font-black uppercase italic mb-1 tracking-widest">Rank</p>
                      <p className="text-2xl font-black text-neon-pink italic tracking-tighter">SILVER</p>
                   </div>
                   <div className="text-center">
                      <p className="text-[9px] text-gray-600 font-black uppercase italic mb-1 tracking-widest">Rewards</p>
