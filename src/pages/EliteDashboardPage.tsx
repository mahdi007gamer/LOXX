...
export const EliteDashboardPage = () => {
 ...
 <div>
 <h1 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-300 via-purple-500 to-fuchsia-500 ">
 ...
 <h3 className="text-xl font-black text-white flex items-center gap-2 mb-2 justify-center md:justify-start">
 <span>کد تخفیف و درآمدزایی استریمر</span>
 <span className="text-[10px] font-bold bg-purple-500/20 border border-purple-500/30 text-purple-300 px-2 py-0.5 rounded-full not-">
 امکان تایید شده
 </span>
 </h3>
