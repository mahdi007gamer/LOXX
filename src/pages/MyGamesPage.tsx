...
export const MyGamesPage = () => {
 ...
 <div className={cn("flex items-center gap-4 text-[10px] md:text-xs font-bold text-gray-500 mb-2 uppercase justify-center", isRtl ? "md:justify-start" : "md:justify-start")}>
 ...
 <div className="absolute top-2 right-2 px-1.5 py-0.5 rounded-md bg-neon-blue text-[8px] font-black text-dark-bg ">POPULAR</div>
 </div>
