        ...
        <div className="flex min-h-[calc(100vh-64px)] overflow-x-hidden pt-16 md:pt-0">
            ...
            <main className="flex-1 flex items-center justify-center p-6 md:mr-64 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl w-full text-center">
                    ...
                    >
                        <h1 className="text-8xl md:text-9xl font-black text-white italic tracking-tighter mb-4 opacity-20 select-none">404</h1>
                        <h2 className="text-3xl md:text-5xl font-black text-white italic tracking-tighter uppercase mb-6 drop-shadow-2xl">
                    ...
                    >
                        ...
                        >
                            <Home size={20} />
                            <span className="font-black uppercase italic">بازگشت به خانه</span>
                        </GlowButton>
                        
                        <button 
                            onClick={() => navigate(-1)}
                            className="w-full sm:w-auto px-8 h-14 rounded-2xl bg-white/5 border border-white/10 text-white font-black uppercase italic hover:bg-white/10 transition-all flex items-center justify-center gap-3"
                        >
