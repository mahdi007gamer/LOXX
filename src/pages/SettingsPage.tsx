...
export const SettingsPage = () => {
 ...
 { id: "support" as const, icon: MessageSquare, label: isRtlStyle ? "سوالات متداول" : "FAQ" },
  ] as const;
...
<div className="flex justify-between items-center mb-4">
 ...
 >
 <img src={badge.iconUrl} alt={badge.name} className={cn("w-16 h-16 sm:w-20 sm:h-20 object-contain mb-2", !hasBadge && "opacity-80")} />
 <span className={cn("text-[10px] font-black uppercase text-center line-clamp-1", hasBadge ? "text-neon-pink" : "text-white")}>{badge.name}</span>
