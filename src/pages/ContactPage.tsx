  ...
  return (
    <div className="flex min-h-screen bg-dark-bg">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 pt-28 pb-12" dir="rtl">
          {/* Header */}
          <motion.div 
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neon-blue/20 bg-neon-blue/5 text-neon-blue text-xs font-black tracking-widest uppercase italic mb-2">
              ...
              <span>پشتیبانی شبانه روزی لوکس</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter italic">ارتباط با ما</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            ...
            >
              ...
              <div className="space-y-2 mt-1 flex-1">
                <h3 className="text-lg font-black text-white">کانال تلگرام</h3>
                <p className="text-xs text-gray-400 font-medium leading-relaxed">جوین شدن به کانال رسمی ما جهت اطلاع از مسابقات و جوایز حامیان</p>
                <div className="pt-2">
                  <a 
            ...
            >
              ...
              <div className="space-y-2 mt-1 flex-1">
                <h3 className="text-lg font-black text-white">پست الکترونیکی</h3>
                <p className="text-xs text-gray-400 font-medium leading-relaxed">ارسال تیکت مستقیم، ایمیل‌های سازمانی و درخواست‌های همکاری</p>
                <div className="pt-2">
                  <a 
            ...
            >
              ...
              <div className="space-y-2 mt-1 flex-1">
                <h3 className="text-lg font-black text-white">شماره تماس پشتیبانی</h3>
                <p className="text-xs text-gray-400 font-medium leading-relaxed">پاسخگویی سریع ۲۴ ساعته در هفت روز هفته برای حل مشکلات لابی</p>
                <div className="pt-2">
                  <a 
            ...
            >
              ...
              <div className="space-y-2 mt-1 flex-1">
                <h3 className="text-lg font-black text-white">آدرس فیزیکی دفتر</h3>
                <p className="text-xs text-gray-400 font-medium leading-relaxed">مراجعه حضوری با هماهنگی قبلی یا ارسال مکاتبات و بسته‌های پستی</p>
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-black text-white italic">درباره پلتفرم امن لوکس (LOXX)</h2>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6 text-xs text-gray-400 font-bold border-t border-white/5 pt-6">
              <span className="flex items-center gap-1.5"><Shield size={14} className="text-neon-blue" /> امنیت تضمین‌شده کاربران</span>
              <span className="flex items-center gap-1.5"><HelpCircle size={14} className="text-neon-pink" /> پشتیبانی مستقیم سیستم</span>
              <span className="flex items-center gap-1.5"><MessageSquare size={14} className="text-emerald-400" /> ارتباط بیواسطه در سراسر کشور</span>
            </div>
          </motion.div>
        </div>
        <Footer />
