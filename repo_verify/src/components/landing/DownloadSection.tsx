...
export const DownloadSection = () => {
 ...
 <h3 className="text-2xl font-black text-white mb-2 z-10 flex items-center gap-2">
 ...
 className="w-full"
 >
 <button className="w-full py-4 px-6 rounded-2xl bg-gradient-to-r from-neon-blue via-teal-400 to-neon-blue bg-[length:200%_auto] text-dark-bg font-black text-sm hover:bg-[right_center] transition-all duration-500 shadow-[0_10px_35px_rgba(0,229,255,0.4)] hover:shadow-[0_15px_45px_rgba(0,229,255,0.6)] cursor-pointer relative overflow-hidden flex items-center justify-center gap-2.5">
 ...
 <span className="mt-3 text-[10px] text-neon-blue font-black uppercase z-10 group-hover:text-neon-pink transition-colors">
